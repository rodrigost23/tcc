...
O protótipo da Figura~\ref{fig:rel_smartleg_1} foi desenvolvido visando baixo custo\todo{Descrever os componentes para o baixo custo}, porém o sistema hidráulico utilizado ocupa muito espaço, o que torna a versão proposta atual inviável para uso diário\todo{Descrever sobre os resultados do trabalho apresentado}.
