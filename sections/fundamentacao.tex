...
\todo[inline]{Seria bom falar um pouco mais sobre as questõe mecanicas sobre movimentação de motores}
...
\begin{figure}[ht]
	...
	\begin{center}
	    \includegraphics[width=0.9\textwidth]{resources/sklearn_iris_svm.png}
	\end{center}
...
\todo[inline]{Sugiro Apresentar algum exemplo/trecho de código}
