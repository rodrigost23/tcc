...
Alguns aspectos cruciais da Robótica são a mecânica, além de sensores e atuadores. A mecânica refere-se à forma física dos robôs: tanto relativo a movimento quanto a estrutura. Sensores são os responsáveis por detectar o ambiente para que se determine como se deve interagir com ele.\todo{referências}
...
\todo[inline]{Descrever que propriedades podem ser validadas usando um FSM. \textbf{Não encontro!!!}}

% ==================================================
\subsection{Redes de Petri}\legend{sec:petrinet}
% ==================================================
