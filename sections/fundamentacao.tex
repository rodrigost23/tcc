...
\todo[inline]{Apresentar um exemplo de utilização da ferramenta, pode ser um trecho do proprio site}
...
\todo[inline]{Ampliar esta seção está bem raza, sugiro falar sobre as técnicas que são usadas na tool, como RNN pre-treinadas. Mencionar quem usa está tool e onde.}
