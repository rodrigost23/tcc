...
\todo[inline]{Falar um pouco mais de tempo real e qual é a relação com a robotica}
...
\todo[inline]{Apresentar um exemplo de IoT com robotica}
...
\todo[inline]{Apresentar um exemplo de uso na industria com uma imagem}

\todo[inline]{Apresentar um exemplo de uso de protese com uma imagem, lembre que no título tem e suas aplicações}
...
\todo[inline]{Apresentar e descrever sensores e atuadores utilizados na robotica}
...
\todo[inline]{Falar sobre as platormas de desenvolvimento para robotica, como Lego Mindstorm - ver http://livros01.livrosgratis.com.br/cp115615.pdf}
...
\label{sec:ml_tools}
Dada a complexidade de algoritmos de aprendizado de máquina, e visando auxiliar na produção de soluções em diversas áreas, estão disponíveis diferentes ferramentas de desenvolvimento. Algumas destas ferramentas serão abordadas nesta seção.
