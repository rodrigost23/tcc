...
\subsection{\textit{Frameworks}\todo{Talvez trocar \textit{frameworks} por \textbf{ferramentas}!}\ para aprendizado de máquina}
...
\todo[inline]{Considerar imagem de \textit{deadlock} de \citeonline[página 86]{peterson:1981}.}
