...
A eletromiografia (EMG) é uma técnica que consiste em monitorar a atividade elétrica gerada pelos músculos do corpo, sendo possível assim detectar os potenciais de ação através desta leitura. Isto significa, teoricamente, que é possível identificar a intenção de uma pessoa ao realizar uma atividade motora a partir de um eletromiograma.
