...
O protótipo para captura de dados consiste, um módulo GY\=/$521$ com um sensor MPU\=/$6050$, que contém um acelerômetro e um giroscópio, e um sensor flexível\todo{Adicionar versão e referências aos sensores}, conectados em um Arduino Nano conforme o esquema da \autoref{fig:result_schem}.
