...
Além disso, os dados na central serão armazenados para uso posterior de análise, que poderá ser feita separadamente, com o auxílio de um computador\todo{Ficou confuso, a classificação será feita fora da protese?} (ver \autoref{sec:metodo_diagnostico}).
