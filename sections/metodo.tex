...
\begin{figure}[h]
	...
	\begin{center}
	   % \includegraphics[width=\textwidth]{resources/hardware_scheme}
	   \missingfigure[figwidth=12cm,figheight=8cm]{Desenho de detalhe da prótese, com articulações, motores, etc.}
	\end{center}
	\legend{Fonte: Elaborada pelo autor}
\end{figure}

A~\autoref{fig:hardware_scheme} mostra o funcionamento dos atuadores do protótipo, que deverão ser acionados de acordo com a classificação dos dados dos sensores. \todo{Explicação dos motores das figuras.}
