...
\todo[inline]{Ainda falta contextualizar um pouco mais}
\todo[inline]{Organizar o texto de forma coesa}
O desafio do desenvolvimento de próteses de membros humanos é manter a funcionalidade de um membro natural. Aspectos desta naturalidade incluem controle intuitivo das articulações, controle da força dos membros para situações diversas, e sentidos tátil e de movimento que existem nos membros naturais \cite{siciliano:2008}.
